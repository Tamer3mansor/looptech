...
const arToEn = new Map([
  ['المشاريع', 'Projects'], ['حلول تطبيقية', 'App solutions'], ['نقدر نبني', 'What we can build'], ['خدماتنا', 'Services'], ['من نحن', 'About us'], ['تواصل معنا', 'Contact'],
  ...
  ['لديك مشروع', 'Have a project'], ['تريد تنفيذه؟', 'you want to build?'], ['شاركنا فكرتك وسيتواصل معك فريقنا لدراسة المتطلبات وتقديم المقترح المناسب.', 'Share your idea and our team will get back to you with the right proposal.'], ['واتساب / هاتف', 'WhatsApp / Phone'], ['البريد الإلكتروني', 'Email'], ['جميع الحقوق محفوظة.', 'All rights reserved.'], ['© 2025 LoopTech. جميع الحقوق محفوظة.', '© 2025 LoopTech. All rights reserved.']
]);
